...
The shinyapp files are located in R/shinyapp/. There, we also have **styles.css** file to customize the app a little bit and all_data.RData, the file with all data and packages needed by the app, generated by execution of get_data.R.
